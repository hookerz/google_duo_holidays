...
//    Main Animation
	tl.add([
	   ...
	   TweenMax.fromTo("#phone01_container", 7, {transformPerspective: 600, rotationX:4, rotationY:-20, rotationZ:0}, {rotationY: 20, rotationX: 10, ease: Power4.easeOut }),
	   TweenMax.fromTo("#phone01_edge", 7, {x: 3, y: 0}, {x: -3, y: 2, ease: Power4.easeOut }),
	   TweenMax.fromTo("#phone01_shine", 6, {x: 10, y: 0, rotation: 25, autoAlpha: 0.15}, {x: -50, y: 20, autoAlpha: 0.08, ease: Power4.easeOut }),
	   
	   TweenMax.fromTo("#phone02_container", 7, {transformPerspective: 600, rotationX:10, rotationY:20, rotationZ:0, x: -20}, {rotationY: -20, rotationX: 4, x: 0, ease: Power4.easeOut }),
	   TweenMax.fromTo("#phone02_edge", 7, {x: -2, y: 1}, {x: 2, y: 0, ease: Power4.easeOut }),
	   TweenMax.fromTo("#phone02_shine", 6, {x: -50, y: 0, rotation: 25, autoAlpha: 0.15}, {x: 0, y: 20, autoAlpha: 0.08, ease: Power4.easeOut }),
	   
	   TweenMax.from("#snowflake01", 7, { rotation: 150, y: -100, delay: 1.25, autoAlpha: 0, ease: Power4.easeOut }),
	   TweenMax.from("#snowflake02", 7, { rotation: -100, y: -50, delay: 1.25, autoAlpha: 0, ease: Power4.easeOut }),
