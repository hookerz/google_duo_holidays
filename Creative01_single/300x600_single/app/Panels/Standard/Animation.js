...
//    Main Animation
	tl.add([
	   ...
	   TweenMax.fromTo("#phone_container", 7, {transformPerspective: 800, rotationX:10, rotationY:20, x: 9, rotationZ:0}, {x: 0, rotationY: -20, rotationX: 4, ease: Power4.easeOut }),
	   TweenMax.fromTo("#phone_edge", 7, {x: -3, y: 2}, {x: 3, y: 0, ease: Power4.easeOut }),
	   TweenMax.fromTo("#phone_shine", 6, {x: -50, y: 0, rotation: 25, autoAlpha: 0.15}, {x: 20, y: 20, autoAlpha: 0.08, ease: Power4.easeOut }),
